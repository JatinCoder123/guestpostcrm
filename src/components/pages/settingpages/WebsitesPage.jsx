        ...
        <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.map((item) => (
            ...
            `}
              ...
              <div className="flex justify-between">
                <span className="font-medium">Non Brand Highest:</span>
                <span>$ {item.non_brand_highest || "-"}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">Non Brand Lowest:</span>
                <span>$ {item.non_brand_lowest || "-"}</span>
              </div>
              {/* Main Asset Checkbox */}
