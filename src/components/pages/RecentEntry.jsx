    ...
    <div className="p-8">
      ...
      <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
        ...
        <div className="bg-green-600 py-4 px-8">
          <div className="grid grid-cols-3 text-left text-white text-lg font-semibold">
        ...
        <div className="px-8 py-4">
          ...
          {events.map((event, index) => (
            <div
              key={index}
              className="grid grid-cols-3 py-5 border-b text-gray-800 hover:bg-gray-50 transition"
            >
              {/* Date */}
