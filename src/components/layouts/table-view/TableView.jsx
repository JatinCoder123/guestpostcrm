      ...
      {moduleKey && model && (
        <Tabs.Root value={section} onValueChange={(value) => { setSection(value); setSearch(""); }}
          ...
          <Tabs.Content value={section} className="mt-0 outline-none">
            <div className="grid min-h-[360px] grid-cols-1 lg:grid-cols-[minmax(280px,1fr)_minmax(300px,420px)]">
              <div className="min-w-0 border-b border-border bg-card lg:border-b-0 lg:border-r">
