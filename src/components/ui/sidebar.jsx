...
export function SidebarGroupLabel({ className, asChild = false, ...props }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-all [&>svg]:size-4 [&>svg]:shrink-0",
...
// ... (Rest of the file is identical: SidebarGroupAction, SidebarMenuButton, etc.)
