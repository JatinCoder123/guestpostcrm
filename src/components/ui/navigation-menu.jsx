...
export const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium " +
    ...
    "disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-accent " +
    ...
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in " +
          ...
          "md:absolute md:w-auto group-data-[viewport=false]/navigation-menu:bg-popover " +
