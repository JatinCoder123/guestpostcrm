...
const LatestMessage = ({ handleMessageClick }) => {
    ...
    const { email, mailersSummary, error } =
        ...
        <>
            ...
            <div className=" flex flex-col justify-between bg-slate-50 rounded-3xl shadow-xl border border-slate-200 p-4  overflow-y-auto custom-scrollbar ">
               ...
               transition-all flex items-center justify-center cursor-pointer"
                            >
                                <img width="44" height="44" src="https://img.icons8.com/keek/100/filled-message.png" alt="filled-message" />                             {count > 0 && (
                    ...
                    <div className="flex  gap-4 ">
                        ...
                        {buttonsLoading ? (
                            ...
                            buttons?.map((btn, i) => (
                                <QuickBtn
                                    key={i}
                                    icon={btn.name == "Ask Budget" ? <HandCoins /> : <ThumbsDown />}
                                    onClick={() =>
                                        handleMove({
                                            email: email1,
                                            threadId,
